...
class Settings(BaseSettings):
    ...
    allowed_origins: str = "http://localhost:5173,http://localhost:3000,http://127.0.0.1:5173,https://posting-pipeline-teal.vercel.app,https://posting-pipeline.vercel.app,https://flow.google,https://flow.google.com,https://labs.google"
